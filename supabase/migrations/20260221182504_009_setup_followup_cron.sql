/*
  # Set up daily follow-up email scheduler
  ...
  2. Notes
    - The cron schedule uses UTC time (14:00 UTC = 9:00 AM ET during EST, 
      or approximately; during EDT it's 13:00 UTC = 9:00 AM)
    - The edge function handles finding confirmed bookings that occurred 3+ days ago
      and sends follow-up emails via Resend
